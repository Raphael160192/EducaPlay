...
<?php
      include('./components/navbar3.html')
    ?>


<main >
<div class="container-fluid" style="background-color: #778899;">
<h4 class="text-white p-4">RANKING DAS MELHORES ATIVIDADES</h4>
</div>
<br>
...
<table class="table table-borderless table-secondary">
  ...
  <tr>
    ...
    <tr>
      <th scope="col">10.000xp</th>
      <td>Regras das práticas de esportes</td>
      <td>10 tópicos</td>
      <td>0 ponts</td>
      <td>100 ponts</td>
    </tr>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Debate sobre corona vírus</td>
      <td>3 tópicos</td>
      <td>0 ponts</td>
      <td>100 ponts</td>
    </tr>
    <tr>
      ...
      <td>Danças-movimentos do corpo</td>
      <td>1 tópicos</td>
      <td>0 ponts</td>
      <td>100 ponts</td>
    </tr>
    ...
    <tr>
      <th scope="row">1.000xp</th>
      <td>Desmatamento e seus efeitos</td>
      <td>1 tópicos</td>
      <td>0 ponts</td>
      <td>100 ponts</td>
    </tr>
